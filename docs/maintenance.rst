...
4. update the example workspace if the new variant should be validated by the
   smoke-test matrix,
5. add or update documentation in this Sphinx tree and the repository README.
...
For documentation-only changes, build the Sphinx site to catch markup and
toctree issues before publishing.