...
def _get_toolchains(tags):
    ...
    for tag in tags:
        toolchain = {
            ...
            "cc_toolchain_linux_features": "@score_bazel_cpp_toolchains//templates/linux:cc_toolchain_linux_features.bzl.template" if tag.target_os == "linux" else None,
...
def _impl(mctx):
    ...
    for toolchain_info in toolchains:
        gcc_toolchain(
            ...
            cc_toolchain_linux_features = toolchain_info["cc_toolchain_linux_features"],
